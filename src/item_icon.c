...
const void *GetItemIconPic(enum Item itemId)
{
    ...
    if (gItemsInfo[itemId].pocket == POCKET_TM_HM)
    {
        ...
        case ITEM_HM_SURF:        return gItemIcon_ChaosSplash;
        case ITEM_HM_WATERFALL:   return gItemIcon_ChaosWaterfall;
        default: break;
        }
...
const u16 *GetItemIconPalette(enum Item itemId)
{
    ...
    if (gItemsInfo[itemId].pocket == POCKET_TM_HM)
    {
        ...
        case ITEM_HM_SURF:        return gItemIconPalette_ChaosSplash;
        case ITEM_HM_WATERFALL:   return gItemIconPalette_ChaosWaterfall;
        default: break;
        }
