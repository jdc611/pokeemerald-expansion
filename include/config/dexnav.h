...
// Flag/var defines
#define DN_FLAG_SEARCHING       FLAG_UNUSED_0x020
#define DN_FLAG_DEXNAV_GET      FLAG_UNUSED_0x021
#define DN_FLAG_DETECTOR_MODE   FLAG_UNUSED_0x022
#define DN_VAR_SPECIES          VAR_UNUSED_0x4091
